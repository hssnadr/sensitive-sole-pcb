...
(library Library_1
	...
	(compDef "NVT2002DP,118" (originalName "NVT2002DP,118") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "VREFA") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "EN") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "VREFB") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "B1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "B2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.nxp.com/docs/en/data-sheet/NVT2001_NVT2002.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "NVT2002DP,118.stp")
